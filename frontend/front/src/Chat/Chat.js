...
const Chat = () => {
    ...
    const getChatroomList = () => {
        ...
        .then(setChatrooms([]))
        .then(response => 
            // console.log(response.data.data.chatRoomList))
    ...
    const readMessage = () => {
        axios.get(`http://localhost:8080/api/readmessage/${my_id}/${ROOM_SEQ}`,config)
        .then(response => console.log(response))
        .catch((Err) => console.error(Err));
    }
